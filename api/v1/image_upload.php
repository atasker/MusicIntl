...
switch ($request_method) {
    case 'POST':
        if (isset($_POST["encoded_image"])) {
            ...
            $upload_path = $upload_directory . $unique_id . ".jpg";

            // Decode base64 image
            $encoded_image = str_ireplace('data:image/jpg;base64,', '', $encoded_image);
            $encoded_image = str_ireplace('data:image/jpeg;base64,', '', $encoded_image);
